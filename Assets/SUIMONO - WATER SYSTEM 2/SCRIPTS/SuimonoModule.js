...
function Start(){
	...
	//enableTenkoku = false;
	//var tenTest : Transform;
	//tenTest = GameObject.Find("Tenkoku DynamicSky").transform;
	//if (GameObject.Find("Tenkoku DynamicSky").transform != null){
		//tenTest = GameObject.Find("Tenkoku DynamicSky").transform;
		//if (tenTest != null) enableTenkoku = true;
	//}
...
function SuimonoGetHeightAll(testObject : Vector3) : float[] {
	...
	// 6 direction
	if (suimonoObject != null) returnValueAll[6]=(suimonoObject.flow_dir_degrees);
	if (suimonoObject == null) returnValueAll[6]=0.0;
	
	// 7 speed
	if (suimonoObject != null) returnValueAll[7]=(suimonoObject.setflowSpeed);
