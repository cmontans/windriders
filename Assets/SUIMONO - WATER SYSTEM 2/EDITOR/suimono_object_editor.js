		...
		*/
        ...
        if (target.showWaves){
        	if (target.typeIndex == 0 || target.typeIndex == 1){
				...
				EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+60, 140, 18),"Deep Wave Height");
				target.waveHeight = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+60, setWidth, 18),"",target.waveHeight,0.0,10.0);
				EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+80, 140, 18),"Deep Wave Scale");
				target.waveScale = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+80, setWidth, 18),"",target.waveScale,0.0,1.0);
			} else {
			...
			if (target.typeIndex == 0 || target.typeIndex == 1){
				EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+100, 140, 18),"Detail Wave Height");
				target.detailHeight = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+100, setWidth, 18),"",target.detailHeight,0.0,3.0);
				EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+120, 140, 18),"Detail Wave Scale");
				target.detailScale = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+120, setWidth, 18),"",target.detailScale,0.0,1.0);
			} else {
			...
			if (target.typeIndex == 0 || target.typeIndex == 1){
			EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+150, 140, 18),"Normalize Shoreline");
			target.normalShore = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+150, setWidth, 18),"",target.normalShore,0.0,1.0);
			EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+170, 140, 18),"Shallow Wave Height");
			target.waveShoreHeight = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+170, setWidth, 18),"",target.waveShoreHeight,0.0,20.0);
			EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+190, 140, 18),"Shallow Wave Scale");
			target.waveShoreScale = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+190, setWidth, 18),"",target.waveShoreScale,0.0,1.0);
        	
        	EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+210, 140, 18),"Shallow Wave Breaks");
        	target.waveBreakAmt = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+210, setWidth, 18),"",target.waveBreakAmt,0.0,20.0);
        	
        	EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+230, 140, 18),"Shallow Wave Speed");
        	target.shoreSpeed = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+230, setWidth, 18),"",target.shoreSpeed,0.0,1.0);
        	}
        ...
        rt = GUILayoutUtility.GetRect(buttonText, buttonStyle);
        EditorGUI.DrawPreviewTexture(Rect(rt.x+margin,rt.y,332,24),divTex);
        ...
        if (target.showFoam){
			...
			EditorGUI.LabelField(Rect(rt.x+margin+10, rt.y+180, 90, 18),"Edge Blend");
        	target.edgeBlend = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+180, setWidth, 18),"",target.edgeBlend,0.0001,0.2);
